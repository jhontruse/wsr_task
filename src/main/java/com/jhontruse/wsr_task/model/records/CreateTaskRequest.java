...
public record CreateTaskRequest(
        ...
        @Column("FEC_REGISTRO")
        @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "America/Lima") @Schema(description = "Fecha de registro del task", example = "2026-04-27 10:00:00")
        LocalDateTime fecRegistro,

        @Column("FEC_VENCIMIENTO")
        @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd HH:mm:ss", timezone = "America/Lima") @Schema(description = "Fecha de vencimiento del task", example = "2026-04-27 10:00:00")
